...
const zhCN = {
  ...
  quote: {
    ...
    fields: { game: "游戏", service: "服务", currentRank: "目前段位", currentDivision: "目前分级", currentStars: "目前星数", currentPoints: "目前分数", currentPeakPoints: "目前巅峰赛分数", currentHeroPowerPoints: "目前英雄战力分数", targetHeroPowerPoints: "目标英雄战力分数", targetRank: "目标段位", targetDivision: "目标分级", targetStars: "目标星数", targetPoints: "目标分数", quantity: "所需数量", completionTime: "理想完成时间", preferredStartTime: "理想开始时间", express: "加急服务", preferredHero: "指定英雄", preferredRole: "指定位置／分路", heroPowerMark: "英雄战力标", quoteStatus: "报价状态", additionalRequirements: "其他要求" },
    ...
    table: { title: "Aurora 专业报价", service: "服务", currentRank: "目前段位", targetRank: "目标段位", currentStars: "目前星数", targetStars: "目标星数", quantity: "所需数量", basePrice: "基本价格", optionalCharges: "附加费用", discount: "折扣", estimatedCompletionTime: "预计完成时间", preferredStartTime: "预约开始时间", finalTotal: "最终总额", reference: "报价编号" },
    actions: { start: "开始查询", submit: "提交", copy: "复制报价", copied: "已复制", whatsapp: "发送到 WhatsApp", edit: "修改选择", human: "联系人工客服", reset: "重新开始" },
    errors: { gameRequired: "请选择游戏。", serviceRequired: "请选择服务。", invalidRank: "所选段位不适用于这款游戏。", currentRankRequired: "请选择目前段位。", targetRankRequired: "请选择目标段位。", divisionRequired: "请选择小分级。", invalidDivision: "所选小分级不适用于这个段位。", targetMustBeHigher: "目标段位必须高于目前段位。", numberRequired: "请输入有效数字；星数可以是零。", positiveNumber: "请输入大于零的数字。", invalidStarRange: "星数不符合所选段位的范围。", heroRequired: "请输入指定英雄。", roleRequired: "请选择指定位置／分路。", invalidRole: "所选分路不适用于这款游戏。", heroPowerMarkRequired: "请选择英雄战力标。", invalidHeroPowerMark: "所选英雄战力标不适用于这款游戏。", expressRequired: "请选择是否需要加急。", requirementsRequired: "请说明套餐或特殊要求。", completionTimeRequired: "请选择理想完成时间。", preferredStartTimeRequired: "请选择理想开始时间。", pricingUnavailable: "价格尚未设置，必须人工确认。" },
