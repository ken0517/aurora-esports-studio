...
const zhCN = {
  ...
  quote: {
    ...
    fields: { game: "游戏", service: "服务", currentRank: "目前段位", currentDivision: "目前分级", currentStars: "目前星数", currentPoints: "目前分数", currentPeakPoints: "目前巅峰赛分数", currentHeroPowerPoints: "目前英雄战力分数", targetHeroPowerPoints: "目标英雄战力分数", targetRank: "目标段位", targetDivision: "目标分级", targetStars: "目标星数", targetPoints: "目标分数", quantity: "所需数量", completionTime: "理想完成时间", preferredStartTime: "理想开始时间", duoGuarantee: "胜负方案", customSchedule: "指定时段要求", winRate70: "全程保持胜率 70% 以上", express: "加急服务", preferredHero: "指定英雄", preferredRole: "指定位置／分路", heroPowerMark: "英雄战力标", quoteStatus: "报价状态", additionalRequirements: "其他要求" },
    ...
    table: { title: "Aurora 专业报价", service: "服务", currentRank: "目前段位", targetRank: "目标段位", currentStars: "目前星数", targetStars: "目标星数", quantity: "所需数量", basePrice: "基本价格", optionalCharges: "附加费用", discount: "折扣", estimatedCompletionTime: "预计完成时间", preferredStartTime: "预约开始时间", bookingDeposit: "预约付款", finalTotal: "最终总额", reference: "报价编号" },
