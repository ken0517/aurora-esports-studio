...
const zhHK = {
  ...
  quote: {
    ...
    fields: {
      game: "遊戲",
      serverCountry: "所在國家／地區",
      serverRegion: "遊戲地區／伺服器大區",
      devicePlatform: "手機系統",
      heroPowerRegion: "戰力地區",
      service: "服務",
      currentRank: "目前段位",
    ...
    prompts: {
      game: "你玩的是哪一款遊戲？",
      serverCountry: "你的 HOK 國際服帳號所在國家／地區是？",
      serverRegion: "你的 HOK 國際服帳號屬於哪一個遊戲地區／伺服器大區？",
      devicePlatform: "你的王者榮耀國服帳號使用 iOS 還是 Android？",
      heroPowerRegion: "你想查詢香港、台灣還是澳門的戰力標？",
      service: "你想查詢哪一項服務？",
    ...
    errors: {
      gameRequired: "請選擇遊戲。",
      invalidServerCountry: "所選國家／地區不適用於這款遊戲。",
      serverRegionRequired: "請選擇遊戲地區／伺服器大區。",
      invalidServerRegion: "所選遊戲地區／伺服器大區不適用於這款遊戲。",
      devicePlatformRequired: "請選擇 iOS 或 Android。",
      invalidDevicePlatform: "所選手機系統不適用於這款遊戲。",
      heroPowerRegionRequired: "請選擇戰力地區。",
      invalidHeroPowerRegion: "所選戰力地區不適用於這款遊戲或服務。",
