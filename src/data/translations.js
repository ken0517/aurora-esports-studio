...
const zhHK = {
  ...
  faqs: [
    ...
    { question: "為甚麼不公開固定價目？", answer: "不同遊戲、伺服器、段位、目標和時段安排不同；只有已配置的規則才能自動計算，其餘轉人工確認。" },
  ...
  quote: {
    ...
    inputLabel: "輸入你的問題",
    inputPlaceholder: "例如：鑽石升星耀幾多錢？",
    suggestions: "搜尋建議",
    noSuggestions: "未找到相符建議，可直接送出問題。",
    listening: "請輸入你的需要",
    manualNotice: "此訂單需要人工確認，我哋可以幫你轉接 WhatsApp 客服。",
...
const en = {
  ...
  faqs: [
    ...
    { question: "Why is there no fixed public price list?", answer: "Game, server, rank, target and timing differ. Only configured rules can calculate automatically; all other requests go to human review." },
...
const zhCN = {
  ...
  hero: {
    eyebrow: "HK · TW MOBILE ESPORTS STUDIO", title: "Welcome", titleAccent: "", description: "走进 Aurora 的专属战场，为香港及台湾玩家带来更从容、更精准的游戏服务体验。", sideNote: "香港为主 · 台湾亦可咨询", serviceNote: "3 GAMES · 1 TEAM · PRIVATE SERVICE", scroll: "向下探索", quoteControl: "向 Aurora客服查询报价", quoteControlShort: "Aurora客服即时报价", quoteDisclaimer: "Aurora客服会按已确认的中央资料协助整理报价需求。",
  },
  ...
  quote: {
    ...
    fields: { game: "游戏", service: "服务", currentRank: "目前段位", currentDivision: "目前分级", currentStars: "目前星数", currentPoints: "目前分数", currentPeakPoints: "目前巅峰赛分数", currentHeroPowerPoints: "目前英雄战力分数", targetHeroPowerPoints: "目标英雄战力分数", targetRank: "目标段位", targetDivision: "目标分级", targetStars: "目标星数", targetPoints: "目标分数", quantity: "所需数量", completionTime: "理想完成时间", express: "加急服务", preferredHero: "指定英雄", preferredRole: "指定位置／分路", heroPowerMark: "英雄战力标", quoteStatus: "报价状态", additionalRequirements: "其他要求" },
    prompts: { game: "你玩哪一款游戏？", service: "你想咨询哪一项服务？", currentRank: "你目前是什么段位？", currentDivision: "目前是哪一个小分级？", currentStars: "目前有多少星？", currentPoints: "目前有多少分？", targetRank: "你想升到哪一个段位？", targetDivision: "目标是哪一个小分级？", targetStars: "目标是多少星？", targetPoints: "目标是多少分？", quantity: "需要多少星、场、局或小时？", completionTime: "你希望什么时候完成？", express: "需要加急吗？", preferredHero: "有没有指定英雄？", additionalRequirements: "还有其他要求吗？" },
    table: { title: "Aurora 专业报价", service: "服务", currentRank: "目前段位", targetRank: "目标段位", currentStars: "目前星数", targetStars: "目标星数", quantity: "所需数量", basePrice: "基本价格", optionalCharges: "附加费用", discount: "折扣", estimatedCompletionTime: "预计完成时间", finalTotal: "最终总额", reference: "报价编号" },
    actions: { start: "开始查询", submit: "提交", copy: "复制报价", copied: "已复制", whatsapp: "发送到 WhatsApp", edit: "修改选择", human: "联系人工客服", reset: "重新开始" },
    errors: { gameRequired: "请选择游戏。", serviceRequired: "请选择服务。", invalidRank: "所选段位不适用于这款游戏。", currentRankRequired: "请选择目前段位。", targetRankRequired: "请选择目标段位。", divisionRequired: "请选择小分级。", invalidDivision: "所选小分级不适用于这个段位。", targetMustBeHigher: "目标段位必须高于目前段位。", numberRequired: "请输入有效数字；星数可以是零。", positiveNumber: "请输入大于零的数字。", invalidStarRange: "星数不符合所选段位的范围。", heroRequired: "请输入指定英雄。", roleRequired: "请选择指定位置／分路。", invalidRole: "所选分路不适用于这款游戏。", heroPowerMarkRequired: "请选择英雄战力标。", invalidHeroPowerMark: "所选英雄战力标不适用于这款游戏。", expressRequired: "请选择是否需要加急。", requirementsRequired: "请说明套餐或特殊要求。", completionTimeRequired: "请选择理想完成时间。", pricingUnavailable: "价格尚未设置，必须人工确认。" },
